...
public class yarin
{
	...
	public static int	SCREENH			= 1280;//屏幕高度
	public static int	BORDERW			= 800;//中间块宽度
	public static int	BORDERH			= 880;//中间块高度，11*块高度
	public static int	BORDERX			= (yarin.SCREENW - BORDERW) / 2;
	public static int	BORDERY			= (yarin.SCREENH - BORDERH) / 2;
